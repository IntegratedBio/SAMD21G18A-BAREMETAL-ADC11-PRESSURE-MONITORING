...
//#define PA24			GPIO(GPIO_PORTA, 24)		//USB TX
//#define PA25			GPIO(GPIO_PORTA, 25)		//USB RX
...
#define ALARM_PIN		GPIO(GPIO_PORTA, 21)		// LOW LEVEL FLOAT SWITCH 				DIGITAL OUTPUT		(D10)	AUDIBLE ALARM
